...
public:
    ...
    static void showMessage(const QString& header, const QString& message, bool check = false, const QString& checkText = QObject::tr("Don't show me again"));
    ...
    static void showMessage(const QString& header, const QString& message, const QString& prefPath, const QString& paramEntry, bool entryDefault = false,
                            bool check = false, const QString& checkText = QObject::tr("Don't show me again");
